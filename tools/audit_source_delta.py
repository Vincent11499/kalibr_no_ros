...
ALLOWED_MODIFICATIONS = {
    ...
    "camera/aslam_cameras_april/include/aslam/cameras/GridCalibrationTargetAprilgrid.hpp": "configurable AprilGrid tag ID offset and corner refinement",
    "camera/aslam_cameras_april/src/GridCalibrationTargetAprilgrid.cpp": "configurable AprilGrid tag ID offset and corner refinement",
    "camera/aslam_cameras_april/src/module.cpp": "configurable AprilGrid tag ID offset and corner refinement binding",
    "camera/aslam_cameras/include/aslam/cameras/CameraGeometry.hpp": "partial-visible focal initialization API",
    "camera/aslam_cameras/include/aslam/cameras/CameraGeometryBase.hpp": "partial-visible focal initialization API",
    "camera/aslam_cameras/include/aslam/cameras/PinholeProjection.hpp": "partial-visible focal initialization API",
    "camera/aslam_cameras/include/aslam/cameras/implementation/CameraGeometry.hpp": "partial-visible focal initialization dispatch",
    "camera/aslam_cameras/include/aslam/cameras/implementation/PinholeProjection.hpp": "guarded partial-visible focal initialization",
    "camera/aslam_cameras/test/PinholeCameraGeometry.cpp": "partial-visible focal initialization tests",
    "camera/aslam_cv_python/src/CameraGeometry.cpp": "partial-visible focal initialization binding",
    "optimization/aslam_backend/include/aslam/backend/Optimizer2.hpp": "compile-time profiling",
    "optimization/aslam_backend/include/aslam/backend/ErrorTerm.hpp": "read-only quadratic observability adapter",
    ...
    "trajectory/aslam_splines/include/aslam/backend/BSplineMotionError.hpp": "read-only quadratic observability adapter",
    ...
    "calibration/kalibr/python/kalibr_calibrate_cameras": "ROS-free models/runtime and partial-visible focal initialization integration",
    ...
    "calibration/kalibr/python/kalibr_camera_calibration/CameraCalibrator.py": "runtime and partial-visible focal initialization integration",
