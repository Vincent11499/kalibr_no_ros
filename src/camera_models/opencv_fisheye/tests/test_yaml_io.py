...
from kalibr_no_ros import opencv_fisheye_io as yaml_io


class OpenCvFisheyeYamlTest(unittest.TestCase):
    ...
    def test_native_equidistant_camchain_is_importable(self):
        data = {
            "cam0": {
    ...
    def test_plain_stereo_flat_r_and_generic_alpha(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            expected_R, expected_T = yaml_io._common.invert_stereo_transform(R, T)
